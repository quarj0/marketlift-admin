...
export default function PaymentDetailPage(){
  ...
  const formattedAmount=new Intl.NumberFormat("en",{style:"currency",currency:payment.currency,maximumFractionDigits:payment.currency==="XOF"?0:2}).format(payment.amount);
