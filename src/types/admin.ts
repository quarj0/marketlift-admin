...
export type AdminMarketRecord = {
  ...
  paymentReadinessMessage: string;
  identityReady: boolean;
  identityReadinessMessage: string;
  launchReady: boolean;
  launchIssues: string[];
};
export type SellerPlanMarketPriceRecord = {
  marketCode: string;
  currency: string;
  planId: string;
  planName: string;
...
export type PromotionMarketPriceRecord = {
  marketCode: string;
  currency: string;
  promotionId: string;
