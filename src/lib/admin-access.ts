...
export type AdminArea = "dashboard" | "users" | "sellers" | "listings" | "categories" | "moderation" | "verifications" | "reports" | "subscriptions" | "payments" | "commerce" | "promotions" | "markets" | "analytics" | "support" | "activity" | "settings";
...
export function areaForPath(pathname: string): AdminArea {
  ...
  return (["users","sellers","listings","categories","moderation","verifications","reports","subscriptions","payments","commerce","promotions","markets","analytics","support","activity","settings"] as AdminArea[]).includes(head as AdminArea) ? head as AdminArea : "dashboard";
}
